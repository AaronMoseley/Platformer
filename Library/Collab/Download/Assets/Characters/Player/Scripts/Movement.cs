...
public class Movement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (!touchingHook && ((xRaw > 0 && !collisions.GetBools()[2]) || (xRaw < 0 && !collisions.GetBools()[1]) || xRaw == 0 || state.Equals("crouching")) && (state.Equals("normal") || state.Equals("crouching")) && ((!waiting || (xRaw > 0 && collisions.GetBools()[1])) || (!waiting || (xRaw < 0 && collisions.GetBools()[2]))))
        {
